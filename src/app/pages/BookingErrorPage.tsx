        ...
        <div className="mx-auto max-w-xl px-4 md:px-8">
          <div className="rounded-3xl border border-lux-orange/40 bg-white p-8 text-center shadow-sm">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <a href={settingsWhatsappLink(settings, "Hi LuxRide, I need help submitting my booking request.")} target="_blank" rel="noreferrer" className="flex flex-1 items-center justify-center gap-2 rounded-full border border-lux-orange/50 py-3 text-sm text-lux-charcoal"><WhatsAppIcon className="h-4 w-4 text-lux-orange" />WhatsApp</a>
            </div>
          </div>
        </div>
      </section>
