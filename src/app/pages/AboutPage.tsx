...
export function AboutPage() {
  ...
  const cards = [
    ...
    { icon: CarFront, title: L("Fleet and Comfort", "الأسطول والراحة"), text: L("The modern fleet includes an MPV, sedan and minivan, all air-conditioned and matched to the passenger and luggage requirements shown during booking.", "يشمل الأسطول الحديث سيارة MPV وسيدان وميني فان، وجميعها مكيفة وتطابق متطلبات الركاب والأمتعة المعروضة أثناء الحجز.") },
