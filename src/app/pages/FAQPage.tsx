...
export function FAQPage() {
  ...
  const faqs: { q: string; a: string }[] = [
    ...
    { q: L("Can I book a Round Trip?", "هل يمكنني حجز ذهاب وعودة؟"), a: L("Yes, when the selected route has an approved round-trip price. LuxRide shows the route classification clearly and never calculates Round Trip by doubling the one-way fare.", "نعم، عندما يكون للمسار المختار سعر ذهاب وعودة معتمد. تعرض LuxRide تصنيف الرحلة بوضوح ولا تحسب الذهاب والعودة أبداً بمضاعفة سعر الذهاب.") },
