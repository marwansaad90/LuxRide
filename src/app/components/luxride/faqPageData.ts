...
export const FAQ_PAGE_ITEMS: Record<Lang, FaqPageItem[]> = {
  EN: [
    ...
    { q: "What happens if my flight is delayed?", a: "LuxRide monitors the flight status in real time and adjusts the airport pickup time accordingly." },
    ...
    { q: "Can I book a Round Trip?", a: "Yes, when the selected route has an approved round-trip price. LuxRide shows the route classification clearly and shows the approved Round Trip price clearly before submission." },
  ...
  AR: [
    ...
    { q: "ماذا يحدث إذا تأخرت رحلتي الجوية؟", a: "تتابع LuxRide حالة الرحلة في الوقت الفعلي وتعدّل موعد استلام المطار وفقاً لذلك." },
    ...
    { q: "هل يمكنني حجز ذهاب وعودة؟", a: "نعم، عندما يكون للمسار المختار سعر ذهاب وعودة معتمد. تعرض LuxRide تصنيف المسار بوضوح وتعرض سعر الذهاب والعودة المعتمد بوضوح قبل الإرسال." },
