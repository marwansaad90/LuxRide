...
export function PageShell({
  ...
  const brandOverlayClass = isContact
    ? lang === "AR"
      ? "bg-[radial-gradient(circle_at_top_right,rgba(204,153,102,0.16),transparent_36%),linear-gradient(180deg,rgba(0,107,92,0.045),transparent)]"
      : "bg-[radial-gradient(circle_at_top_left,rgba(204,153,102,0.16),transparent_36%),linear-gradient(180deg,rgba(0,107,92,0.045),transparent)]"
    : lang === "AR"
      ? "bg-[radial-gradient(circle_at_top_right,rgba(204,153,102,0.24),transparent_38%),linear-gradient(180deg,rgba(0,107,92,0.08),transparent)]"
      : "bg-[radial-gradient(circle_at_top_left,rgba(204,153,102,0.24),transparent_38%),linear-gradient(180deg,rgba(0,107,92,0.08),transparent)]";
  ...
  return (
    <>
      ...
      <section className={`relative overflow-hidden pt-28 pb-14 md:pt-32 md:pb-16 ${isBrand ? (isContact ? "bg-[#FBF5EF]" : "bg-[#F6EFE6]") : "bg-lux-dark"}`}>
        <div className={`absolute inset-0 ${isBrand ? brandOverlayClass : "bg-gradient-to-b from-lux-green/10 to-transparent"}`} />
