...
const T = {
  EN: {
    // Header nav
    nav_home: "Home",
    nav_transfers: "Airport Transfers",
    ...
    calc_permit_notice: "This journey requires an official tourism and security travel permit. LuxRide can arrange the required permit on your behalf.",
    ...
    // Footer
    footer_desc: "Premium private limousine and tourist transfer service in Hurghada, Egypt. Reliable, comfortable and professionally managed journeys.",
    footer_quick: "Quick Links",
    footer_dests: "Popular Destinations",
    footer_contact: "Contact",
    footer_addr: "Hurghada, Red Sea, Egypt",
    footer_wa: "WhatsApp us",
    footer_copy: "LuxRide Egypt. All rights reserved.",
  ...
  AR: {
    ...
    book_your_transfer: "احجز رحلتك",

    // Hero
    hero_badge: "الغردقة · مصر",
    hero_h1_1: "تحويلات خاصة",
    hero_h1_2: "فاخرة في",
    hero_h1_3: "الغردقة",
    ...
    calc_cutoff_err: "يجب حجز هذه الرحلة قبل ٣ ساعات على الأقل من موعد المغادرة. الرجاء استخدام الحجز اللحظي عبر واتساب.",
    calc_permit_notice: "تتطلب هذه الرحلة تصريح سفر سياحي وأمني رسمي. يمكن لـ LuxRide ترتيب التصريح المطلوب نيابةً عنك.",
    ...
    dest_title: "رحلات خاصة عبر مصر",
    dest_sub: "استكشف خدمات النقل المخصصة لدينا لكل وجهة رئيسية.",
    dest_1: "تحويلات مطار الغردقة",
    dest_2: "تحويلات الجونة",
    dest_3: "تحويلات مكادي باي",
    dest_4: "تحويلات سوما باي",
    dest_5: "تحويلات سهل حشيش",
    dest_6: "تحويلات الأقصر الخاصة",
    dest_7: "تحويلات مرسى علم",

    // Final CTA
    cta_title: "هل أنت مستعد لحجز رحلتك الخاصة؟",
    ...
    // Footer
    footer_desc: "خدمة ليموزين خاصة فاخرة ونقل سياحي في الغردقة، مصر. رحلات موثوقة ومريحة ومُدارة باحترافية.",
    footer_quick: "روابط سريعة",
    footer_dests: "الوجهات الشائعة",
    footer_contact: "اتصل بنا",
    footer_addr: "الغردقة، البحر الأحمر، مصر",
    footer_wa: "راسلنا على واتساب",
    footer_copy: "LuxRide مصر. جميع الحقوق محفوظة.",
