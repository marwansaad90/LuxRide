...
const ARABIC_LOCATION_LABELS: Record<string, string> = {
  ...
  Hurghada: "الغردقة",
  "Hurghada City Center": "مركز مدينة الغردقة",
  "El Gouna": "الجونة",
...
const T = {
  EN: {
    ...
    calc_overday: "Round Trip",
    calc_overnight: "Round Trip",
    calc_oneway_desc: "Single transfer",
    calc_overday_desc: "Outbound and return transfer",
    calc_overnight_desc: "Outbound and return transfer",
    calc_hotel: "Hotel name or exact destination",
    calc_hotel_ph: "e.g. Hotel name or exact address",
    ...
    fleet_sub: "Modern and immaculately maintained for every group size.",
  ...
  AR: {
    ...
    // Booking calculator — extended
    calc_overday: "ذهاب وعودة",
    calc_overnight: "ذهاب وعودة",
    calc_oneway_desc: "توصيلة ذهاب واحدة",
    calc_overday_desc: "توصيلة ذهاب وعودة",
    calc_overnight_desc: "توصيلة ذهاب وعودة",
    calc_hotel: "اسم الفندق أو موقع الوصول بالتحديد",
    calc_hotel_ph: "مثال: اسم الفندق أو العنوان بالتحديد",
    ...
    fleet_sub: "سيارات حديثة ومُصانة بعناية لكل حجم مجموعة.",
    fleet_ac: "تكييف هواء",
