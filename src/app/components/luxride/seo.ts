...
export const PUBLIC_SEO_ROUTES: SeoConfig[] = [
  ...
  },
  {
    ...
    description: "View LuxRide Taxi vehicles for private transfers in Hurghada, including air-conditioned MPV, sedan, and minivan options matched to passenger and luggage needs.",
  },
  {
    path: "/destinations",
