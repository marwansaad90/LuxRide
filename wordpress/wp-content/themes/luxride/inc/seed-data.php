...
function luxride_seed_destinations(): array
{
    ...
    return [
        luxride_destination_record('airport-hurghada', 101, 'Hurghada Airport', 'Hurghada', 'Hurghada-16to9-D7nDlys_.jpg', '20 min', 13, array_merge($airport, ['luxride_context' => 'popular,destination', 'luxride_image_position' => 'center'])),
        ...
        luxride_destination_record('hurghada-city-airport', 201, 'Hurghada', 'Hurghada Airport', 'Airport-16to9-DotxZx8X.jpg', '20 min', 13, array_merge($area, ['luxride_context' => 'popular,destination', 'luxride_image_position' => 'center', 'luxride_display_from_en' => 'Hurghada City', 'luxride_display_from_ar' => 'مدينة الغردقة'])),
...
function luxride_seed_faqs(): array
{
    $home_en = [
        ...
        ['What happens if my flight is delayed?', 'LuxRide monitors your flight status in real time and adjusts the airport pickup time accordingly. Free waiting is provided for up to 3 hours from the actual arrival time.'],
    ...
    $home_ar = [
        ...
        ['ماذا يحدث إذا تأخرت رحلتي الجوية؟', 'تتابع LuxRide حالة الرحلة لحظياً ويتم تعديل وقت الاستقبال وفقاً لموعد الوصول الفعلي، مع انتظار مجاني بحد أقصى 3 ساعات.'],
