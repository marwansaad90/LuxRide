...
function luxride_seed_destinations(): array
{
    ...
    return [
        ...
        luxride_destination_record('hurghada-city-airport', 201, 'Hurghada', 'Hurghada Airport', 'airport-client-DcCKDvLK.jpg', '20 min', 13, array_merge($area, ['luxride_context' => 'popular,destination', 'luxride_image_position' => 'center 82%', 'luxride_display_from_en' => 'Hurghada City', 'luxride_display_from_ar' => 'مدينة الغردقة'])),
