# LuxRide confirmed client input still required

Only unresolved client-owned or operational information is listed here. None of these values is invented or shown as a public placeholder.

| Required client input | Needed for |
| --- | --- |
| Production business email | Contact routing, booking notifications, and final site settings |
| Confirmed business hours | Publishing an accurate contact schedule |
...
| Final production availability of Corolla and HiAce | Confirming whether Corolla and HiAce remain Coming Soon after client testing |

Vehicle availability clarification:

- All three vehicles are currently enabled only for client testing in the review prototype.
- The previously agreed production state remains Mitsubishi Xpander: Available, Toyota Corolla: Coming Soon, Toyota HiAce: Coming Soon.
- Do not change the production state permanently until the client confirms it after testing.
